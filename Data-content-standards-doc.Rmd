...
This report was produced using data content from the January 2023 snapshot of Central Biotics on `r format(Sys.Date(), '%B %d, %Y')`. Data from past years were also included in some figures for a multi-year comparison.
